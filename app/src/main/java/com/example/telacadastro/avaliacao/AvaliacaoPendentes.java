...
public class AvaliacaoPendentes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_avaliacao_pendentes);
        ...
        btnAdmin.setOnClickListener(v -> {
            Intent intent = new Intent( AvaliacaoPendentes.this, Menu.class);
            startActivity(intent);
        });

        btnResConfirmadas.setOnClickListener(v -> {
            Intent intent = new Intent( AvaliacaoPendentes.this, ReservasConfirmadas.class);
            startActivity(intent);
        });

        btnResCanceladas.setOnClickListener(v -> {
            Intent intent = new Intent( AvaliacaoPendentes.this,ReservasCanceladas.class);
            startActivity(intent);
        });

        btnResPentende.setOnClickListener(v -> {
            Intent intent = new Intent( AvaliacaoPendentes.this, ReservasPendentes.class);
            startActivity(intent);
        });

        btnAvRecebidas.setOnClickListener(v -> {
            Intent intent = new Intent( AvaliacaoPendentes.this, AvaliacoesRecebidas.class);
            startActivity(intent);
        });
    }
    }
