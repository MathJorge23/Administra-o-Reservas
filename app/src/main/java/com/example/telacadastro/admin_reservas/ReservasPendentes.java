...
public class ReservasPendentes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reservas_pendentes);
        ...
        btnResConfirmadas.setOnClickListener(v -> {
            Intent intent = new Intent( ReservasPendentes.this, ReservasConfirmadas.class);
            startActivity(intent);
        });

        btnResCanceladas.setOnClickListener(v -> {
            Intent intent = new Intent( ReservasPendentes.this, ReservasCanceladas.class);
            startActivity(intent);
        });

        btnResPentende.setOnClickListener(v -> {
            Intent intent = new Intent( ReservasPendentes.this,ReservasPendentes.class);
            startActivity(intent);
        });

        btnAvRecebidas.setOnClickListener(v -> {
            Intent intent = new Intent( ReservasPendentes.this, AvaliacoesRecebidas.class);
            startActivity(intent);
        });
    }
    ...
    public void buscarReservasPendentes() {
        ...
        db.collection("reservas")
                .whereEqualTo("status", "P") // Filtrar apenas as reservas com status "P"
                .get()
